        ...
        <WholeWrapper>
          <RsWrapper padding={`100px 0 50px`}>
            <Wrapper al={`flex-start`}>
              ...
              <Text isEng={true} fontSize={`16px`}>
                In picture: Harald Lavik &#38; Morten Torlei
              </Text>

              <Text fontSize={`42px`} fontWeight={`800`} margin={`80px 0 40px`}>
                AVA 브랜드 창립자
              </Text>

              <Text fontSize={width < 900 ? `16px` : `20px`}>
                저희는 무엇이 기능적이고 무엇이 기능적이지 않은지에 대한 충분한
                경험을 쌓았습니다.
              </Text>
              <Text
              ...
              <Text
                ...
                margin={`0 0 40px`}
              >
                까다로운 고객에게 어떠한 방법으로 영업을 하는지 배워 성장하게
                되었습니다.
              </Text>
              ...
              <Text
                ...
                margin={`0 0 40px`}
              >
                저희의 디자이너, 엔지니어들은 AVA 브랜드를 더욱 개선 및 구축을
                위해 더 나은 해결방안을 찾으며 협력하고 있습니다.
              </Text>
              ...
              <Text
                ...
                margin={`0 0 60px`}
              >
                저희는 AVA 브랜드가 고압세척기의 경험을 재창조 했다고 자랑스럽게
                말씀 드릴 수 있습니다.
              </Text>

              <Text fontSize={`18px`} fontWeight={`600`} margin={`0 0 110px`}>
