      ...
      <ClientLayout>
        <WholeWrapper>
          <Wrapper>
            ...
            >
              <RsWrapper al={`flex-end`} ju={`flex-end`} position={`relative`}>
                <Image
                  alt="smart"
                  src={`https://ags-s3.s3.ap-northeast-2.amazonaws.com/ags/assets/images/banner/img_prod-smart.png`}
                  width={
          ...
          >
            <Image
              alt="smart image1"
              src={`https://ags-s3.s3.ap-northeast-2.amazonaws.com/ags/assets/images/prod-smart/img_1.png`}
              width={`calc(100% / 2.05)`}
              minWidth={`300px`}
            />
            <Image
              alt="smart image2"
              src={`https://ags-s3.s3.ap-northeast-2.amazonaws.com/ags/assets/images/prod-smart/img_2.png`}
              width={`calc(100% / 2.05)`}
              minWidth={`300px`}
          ...
          >
            <Image
              alt="smart image1"
              src={`https://ags-s3.s3.ap-northeast-2.amazonaws.com/ags/assets/images/prod-smart/img_3.png`}
              width={`calc(100% / 3.1)`}
              minWidth={`300px`}
            />
            <Image
              alt="smart image2"
              src={`https://ags-s3.s3.ap-northeast-2.amazonaws.com/ags/assets/images/prod-smart/img_4.png`}
              width={`calc(100% / 3.1)`}
              minWidth={`300px`}
              margin={width < 800 && `0 15px`}
            />
            <Image
              alt="smart image3"
              src={`https://ags-s3.s3.ap-northeast-2.amazonaws.com/ags/assets/images/prod-smart/img_5.png`}
              width={`calc(100% / 3.1)`}
              minWidth={`300px`}
            />
          </Wrapper>
          ...
          >
            <RsWrapper>
              ...
              <Wrapper dr={`row`}>
                <Image
                  alt="smart model"
                  src={`https://ags-s3.s3.ap-northeast-2.amazonaws.com/ags/assets/images/prod-smart/img_model-eq.png`}
                  width={`275px`}
                />
                <Image
                  alt="smart table"
                  src={`https://ags-s3.s3.ap-northeast-2.amazonaws.com/ags/assets/images/prod-smart/img_graph.png`}
